...
<head>
    ...
    <title> Loja Eletrônicos / Informática</title>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{route('atividade.index')}}" class="dropdown-item">
                                    ...
                                    <span class="ps-1">Atividades</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{route('integrante.index')}}" class="dropdown-item">
                                    ...
                                    <span class="ps-1">Integrantes</span>        
                                </a>
                            </li>
                            <li>
                                <a href="{{route('material.index')}}" class="dropdown-item">
                                    ...
                                    <span class="ps-1">Materiais</span>        
                                </a>
                            </li>    
                        </ul>
                    </li>
